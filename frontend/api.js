...
const ComponentAPI = {
     ...
     */
    async getById(id) {
        const response = await apiRequest(`/components/${id}`);
        return response.json();
    },
    ...
    async create(componentData) {
        const response = await apiRequest('/components', {
            method: 'POST',
...
const RequestAPI = {
    ...
    async markReturned(id) {
        const response = await apiRequest(`/requests/${id}/return`, {
            method: 'POST'
        });
        return response.json();
    }
